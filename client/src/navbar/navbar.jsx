...
//   try {
//     if (!searchValue.trim()) {
//       setSearchedProducts(null); // 👈 reset when empty
//       return;
//     }
...
//           <Link to= {"/"}><img src={bwkuf} alt="logo" className="w-28 sm:w-32 md:w-40" /></Link>
...
//          <input
//   type="text"
//   className="hidden md:block h-8 px-3 rounded border dark:bg-gray-800"
...
//             <Link to= {"/setting"}><button onClick={() => setShowLogout(!showLogout)}>
...
//           <input
//             type="text"
//             className="w-full h-8 px-3 mb-3 rounded border dark:bg-gray-800"
//             placeholder="Search products"
//             value={search}
...
//             {["/", "/Men", "/Women", "/MobileCover", "/Product"].map((path, i) => (
//               <Link
//                 key={i}
//                 to={path}
