...
// // import ss from "../login ss/login.jpg"
// // const Setting = () => {
...
// //             <button className="w-10 h-10 rounded-full bg-blue-700 text-white flex items-center justify-center text-lg">f</button>
// //             <button className="w-10 h-10 rounded-full bg-blue-400 text-white flex items-center justify-center text-lg">t</button>
// //             <button className="w-10 h-10 rounded-full bg-red-600 text-white flex items-center justify-center text-lg">G</button>
// //           </div>
// //         </div>
// //       </div>
// //     </div>
...
//             {/* Title changes with ternary operator */}
...
//             {/* Switch link using ternary operator */}
//             <div className="text-center mt-5">
//               <button
//                 onClick={() => setLogin(!login)}
//                 className="text-gray-700 underline"
//               >
//                 {login ? "Create an account" : "Already have an account? Login"}
//               </button>
//             </div>
