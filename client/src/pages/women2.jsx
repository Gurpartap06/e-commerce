        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <div className="space-y-1">
            ...
            <div className="text-sm text-gray-500">
              <span className="line-through mr-2">₹{ab.price}</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button onClick={handleAdd} className="bg-pink-500 hover:bg-pink-600 text-white font-semibold py-2 px-6 rounded shadow">
              Add to Cart
            </button>
